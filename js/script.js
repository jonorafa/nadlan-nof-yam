...
const PROPERTIES_DATA = [
    { id: 'amir',      title: 'אמיר גלבוע 7',                              titleEn: 'Amir Gilboa 7',                              location: 'רמת אביב החדשה',    locationEn: 'New Ramat Aviv',       price: '₪ 8,800,000',    image: 'images/bien5/amir-cover.jpg',           link: 'property-amir.html' },
    { id: 'gan',      title: 'דירת גן יוקרתית בבניין בוטיק',              titleEn: 'Luxury Garden Apartment | Boutique Building', location: 'רמת אביב החדשה',    locationEn: 'New Ramat Aviv',       price: '₪ 11,500,000',   image: 'images/bien4/gan-cover.jpg',            link: 'property-gan.html' },
    { id: 'einstein',  title: 'דירת 5 חדרים בבלעדיות',                    titleEn: '5-Room Apartment (Exclusive)',               location: 'רמת אביב החדשה',    locationEn: 'New Ramat Aviv',       price: '₪ 6,300,000',      image: 'images/einstein/einstein-cover.jpg',    link: 'property-einstein.html' },
    { id: 'duplex',    title: 'בלעדיות חדשה | דופלקס פנטהאוז נדיר',       titleEn: 'New Exclusive | Rare Duplex Penthouse',      location: 'ישה חפץ 11, רמת אביב החדשה', locationEn: 'Yasha Hefetz 11, New Ramat Aviv', price: '₪ 11,500,000', image: 'images/bien2/duplex-cover.jpg',         link: 'property-duplex.html' },
    { id: 'sheket',    title: 'דירת 3.5 חדרים ענקית',                     titleEn: 'Huge 3.5-Room Apartment',                    location: 'רמת אביב החדשה',    locationEn: 'New Ramat Aviv',       price: '₪ 4,500,000',      image: 'images/bien3/sheket-cover.jpg',         link: 'property-sheket.html' },
